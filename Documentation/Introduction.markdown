This document is a proposal for an extension to the Digital Delta API, specifically for parameter-based queries, as opposed to the time-series focused approach that the original DD API used.
